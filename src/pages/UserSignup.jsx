              ...
              <form className="space-y-4">
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    <label htmlFor="userName" className="block text-blue-700 text-sm font-bold mb-2">Username</label>
                    <input type="text" id="userName" placeholder="Enter username" className="w-full p-2 rounded bg-white-100 border border-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-300" required />
                  </div>
