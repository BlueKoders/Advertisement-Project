...
const VendorSignup = () => {
  return (
    <div className='school'>
      <Navbar />
      <div className="bg-white-300 flex items-center justify-center mt-28 mb-24">
          ...
          <form className="space-y-4">
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <input type="password" id="confirmPassword" className="w-full p-2 rounded bg-white-100 border border-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-300" placeholder="Confirm Password" required />
              </div>
            </div>
